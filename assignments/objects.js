...
for (let i = 0; i < interns.length; i++) {
  ...
  if (intern.name === 'Antonietta') {
    ...
    intern.multiplyNums = function(a, b) {
      return a * b;
    }
  }
}
...
// Log the child's age
console.log(`${parent.name} has a child aged ${parent.child.age}`);
// Log the name and age of the grandchild
console.log(`${parent.name}'s grandchild ${parent.child.grandchild.name} is ${parent.child.grandchild.age}`);
